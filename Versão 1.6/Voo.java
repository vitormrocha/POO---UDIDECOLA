...
public class Voo extends Trecho {
    // ================================= Atributos
        private ArrayList<Data> voosCad;
        private Horario horarioSaida;
        private Horario horarioChegada;
        private int indiceMes;
        private int ocorrenciaMensal;
        private int modalidadeMensal;
        private int diaDaSemana;
        private Data data;

    // ================================= Construtores
    public Voo(String codigoIdentificador, String localSaida, String localChegada, float preco, CompanhiaAerea companhiaAerea, Horario horarioSaida, Horario horarioChegada, Horario horarioSaida1, Horario horarioChegada1, int indiceMes, int ocorrenciaMensal, int modalidadeMensal, int diaDaSemana, Data data) {
        super(codigoIdentificador, localSaida, localChegada, preco, companhiaAerea, horarioSaida, horarioChegada);

        this.horarioSaida       = horarioSaida1;
        this.horarioChegada     = horarioChegada1;
    ...
    public void exibirVoo() {
        ...
        System.out.println("- Ele vai ocorrer " + ocorrenciaMensal + " vez(es) no mes.");
        System.out.println("Datas encontradas para o voo:");
        for (Data data : voosCad) { data.exibeData(); }
    }

    public void cadastrarVooUmaVezPorMes(){
        Data dataVoo    = new Data(1,1,2024); // Data genérica que iremos manipular
        ...
        int maxDiasMes = data.quantidadeDiasNoMes(indiceMes,dataVoo.getAno()); // Int que garante a leitura completa de um mês
    ...
    public void cadastrarVooDiarioNoMes() {
        ...
        System.out.println("[ Ocorre todas as vezes no mes ] ");
