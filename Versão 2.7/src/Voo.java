...
public class Voo extends Trecho {
    ...
    private Aviao aviaoQueVoara;            // aviao que voará nesse voo
    ...
    // ================================= Construtores
    public Voo(String codigoIdentificador, Aviao aviaoQueVoara, Horario hSaida, Horario hChegada, int indiceMes, int ocorrenciaMensal, int modalidadeMensal, int diaDaSemana) {
        super(codigoIdentificador);
        this.aviaoQueVoara      = aviaoQueVoara;
    ...
    public void setOcorrenciaMensal(int ocorrenciaMensal) {
        ...
        else this.ocorrenciaMensal = ocorrenciaMensal;
    }
    ...
    public void setDiaSemana(int diaDaSemana) {
        if ((diaDaSemana < 0) || diaDaSemana > 8)
            throw new IllegalArgumentException("Forneça uma escolha válida!\n");
        else this.diaDaSemana = diaDaSemana;
    }

    public Aviao getAviaoQueVoara() { return aviaoQueVoara; }
    ...
    public void exibirVoo() {
        ...
        System.out.println("- E o seu aviao eh: ");
        aviaoQueVoara.exibirAviao();;
        ...
        if (modalidadeMensal == 2)
        {
            switch (diaDaSemana)
            {
                ...
                case 3: // Ultima sexta-sabado
                    for (dia = 1; dia <= maxDiasMes; dia++) // Essa iteracao é puramente pra saber quantas sexta-sabado temos, e com isso, achamos o penultimo:
    ...
    public void cadastrarVooQuatroVezesPorMes() {
        ...
        // Reservas para as quatro primeirss aparicoes do setDiaSemana nesse mes
        if (modalidadeMensal == 1)
        { percorreMes(mes, anoAtual, contagem, maxDiasMes); }

        // primeira ocorrencia de sexta/sabado do mes, pula uma semana, reserva a sexta/segunda
        if (modalidadeMensal == 2)
        {
    ...
    // Quando estamos percorrendo o mes, e reservando dois dias ao mesmo tempo
    ...
    // Quando queremos percorrer o mes, e fazendo uma reserva por iteraãoL
