public class Main {
    public static void main(String[] args)
    {
        ...
        Hotel hotel = new Hotel("123", "NOME OFICIAL", "NOME CRIACAO", dataCriacao, endereco, 5, true, quartosHotel, Check_in, Check_out, divulgacao,"Hotel BAUM demais", 10, 5);
...
//        hotel.getQuartosHotel().hospedarDia(new Data(19, 12, 2003), 34, QuartosHotel.TipoQuarto.LUXO);
        ...
        hotel.getQuartosHotel().hospedar(new Data(25, 1, 2024), new Data(3, 2, 2024), 1, QuartosHotel.TipoQuarto.SINGLE);
