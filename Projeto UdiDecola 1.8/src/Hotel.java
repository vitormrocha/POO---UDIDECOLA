...
public class Hotel extends Empresa{
    ...
    // ================================= Construtores
    public Hotel(String cpnj, String nomeOficial, String nomeCriacao, Data dataCriacao, Endereco endereco, int numeroEstrelas, boolean aceitaPets, QuartosHotel quartosHotel, Horario check_in, Horario check_out, String fraseDivulgacao, String descricaoHotel, int remuneracaoPagaPorDiaria, double preco_buffet) {
